export function IconUser({ color }: any) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="icon icon-tabler icon-tabler-user inline-block pointer-events-none"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      strokeWidth="2"
...
export function IconOrganize() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="icon icon-tabler icon-tabler-subtask inline-block pointer-events-none"
      width="24"
      height="24"
      viewBox="0 0 24 24"
      strokeWidth="2"
